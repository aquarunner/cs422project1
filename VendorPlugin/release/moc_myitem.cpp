...
**
** Created: Tue Apr 17 09:11:49 2012
...
static const char qt_meta_stringdata_MyItem[] = {
    "MyItem\0"
};

const QMetaObject MyItem::staticMetaObject = {
    { &QDeclarativeItem::staticMetaObject, qt_meta_stringdata_MyItem,
      qt_meta_data_MyItem, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyItem))
